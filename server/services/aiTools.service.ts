 ...
 *
 * Produces a single PDF with a SMEEP-branded header banner, document metadata,
...
export async function generateBusinessDocumentPdf(
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    doc.fillColor('#6b7280').fontSize(11).font('Helvetica')
       .text('Generated by SMEEP AI Business Assistant — potential.com');
    doc.moveDown(0.5);
    ...
    for (let i = 0; i < range.count; i++) {
      ...
      doc.fillColor('#9CA3AF').fontSize(9).font('Helvetica')
         .text(
           `Generated with SMEEP AI Business Assistant — potential.com    ·    Page ${i + 1} of ${range.count}`,
           50,
           doc.page.height - 30,
