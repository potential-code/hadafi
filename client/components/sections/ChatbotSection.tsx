      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <SectionHeader
            ...
            heading={
              <span className="text-2xl sm:text-3xl font-extrabold tracking-tight flex items-center justify-center">
                <span className="text-white mr-2">Hana –</span>
        ...
        >
          ...
          <div className="absolute -top-10 left-1/2 -translate-x-1/2 z-10">
            ...
            >
              <img src="/images/redesign/hadafi-avatar-96.png" alt="Hana avatar" className="w-full h-full object-cover" />
              <motion.div
                aria-hidden
            ...
            <div className="space-y-4 mb-8">
              ...
              >
                <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 border border-white/20">
                  <img src="/images/redesign/hadafi-avatar-96.png" alt="Hana" className="w-full h-full object-cover" />
                </div>
